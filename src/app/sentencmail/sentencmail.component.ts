...
@Component({
  ...
  templateUrl: './sentencmail.component.html',
  styleUrls: ['./sentencmail.component.css']
})

export class SentencmailComponent implements OnInit {
  details: UserDetails;
  fullname: String;
  userid: string;
  useremail: string;
  ...
  getMails(page, limit) {
    ...
    this.http.post(this.AppComponent.BASE_URL + '/api/getencmail/' + page + '/' + limit, { userid: this.userid })
      .subscribe(data => {
  ...
  ngOnInit() {
    ...
    this.auth.profile().subscribe(user => {
      ...
      this.getMails(this.page, this.limit)
      //  this.http.post(this.AppComponent.BASE_URL+'/api/getencmail', {userid:this.userid})
      //  .subscribe(data => {
      //    this.mails = data;
      //    this.sentmails= this.mails.data;
      //  });
